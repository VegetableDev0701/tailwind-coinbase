    ...
    <main className="ctw-flex ctw-flex-col ctw-items-center ctw-justify-between ctw-pt-[80px]">
      <div className="ctw-w-[448px] ctw-border-solid ctw-border-[1px]  ctw-rounded-[18px] ctw-border-[rgba(138,145,158,0.2)] ctw-p-[40px] ctw-pb-[24px] ctw-pb-[24px]">
        ...
        <div className="ctw-pb-[40px]">
          <h2 className="ctw-text-[28px] ctw-font-semibold ctw-leading-[36px] ctw-text-white">Enter the 7-digit code we texted to +* *******</h2>
          <div className="ctw-pt-[8px] ctw-text-u-gray">This helps us keep your account secure by verifying that it’s really you.</div>
        </div>
        ...
        <div className="ctw-py-[24px] ctw-text-center">
          <p className="ctw-text-[rgb(55,115,245) ctw-text-[16px]] cds-body-bvviwwo ctw-text-[#3773f5] ctw-cursor-pointer">Having trouble? Try another way</p>
        </div>
      </div>
      <div className="ctw-py-[24px] ctw-text-center">
        <p className="ctw-text-[rgb(55,115,245)] ctw-cursor-pointer ctw-text-[16px] ctw-leading-[24px]">Cancel signing in</p>
      </div>
    </main>
  );
}
