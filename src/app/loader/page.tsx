  ...
  return (
    <main className="ctw-flex ctw-flex-col ctw-items-center ctw-justify-between ctw-pt-[80px]">
      <div className="sm:ctw-w-full md:ctw-w-[448px] ctw-border-solid ctw-border-[1px]  ctw-rounded-[18px] ctw-border-gray-500 ctw-p-[40px] ctw-pb-[24px] ctw-pb-[24px]">
        ...
        <div className="ctw-py-[40px] ctw-flex ctw-text-center ">
          <div className="ctw-m-auto">
            <svg aria-hidden="true" className="ctw-w-[58px] ctw-h-[58px] ctw-text-gray-200 ctw-animate-spin dark:ctw-text-gray-600 ctw-fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
